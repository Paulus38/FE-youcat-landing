  ...
  if (!id || isNaN(questionId)) {
    return (
      <Container maxWidth="lg" sx={{ py: 4 }}>
        <Typography variant="h4" component="h1" color="error" align="center" gutterBottom>
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Typography variant="subtitle1" align="center" color="text.secondary" paragraph>
        {t('singleQuestionDescription') || 'Test your knowledge with this question. Choose the correct answer!'}
      </Typography>
      
      <Box mt={4}>
        <QuizSingleQuestion questionId={questionId} />
      </Box>
    </Container>
  );
};
